...
public class SignUpTestsMishurova {
    ...
    public void searchForBookByName() {
        ...
        searchButton.click();
        Assert.assertTrue(driver.findElement(By.cssSelector("War and Peace")).isDisplayed(), " Relevant books should be displayed " );
    ...
    public void searchForBookByAuthor() {
        ...
        WebElement searchButton = driver.findElement(By.cssSelector("[value='Search']"));
        searchButton.click();
        Assert.assertTrue(driver.findElement(By.cssSelector("Leo Tolstoy")).isDisplayed(), " Relevant books should be displayed " );
    }
